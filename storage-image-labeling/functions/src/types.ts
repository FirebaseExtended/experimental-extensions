...
export type IAnnotatedImageRequest = vision.protos.google.cloud.vision.v1.IAnnotateImageRequest;
export type ImageContext = vision.protos.google.cloud.vision.v1.IImageContext;
export type IAnnotatedImageResponse = vision.protos.google.cloud.vision.v1.IAnnotateImageResponse;
export type IEntityAnnotation = vision.protos.google.cloud.vision.v1.IEntityAnnotation;