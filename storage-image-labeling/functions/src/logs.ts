...
export const noContentType = () => {
    logger.log("Ignoring file as unable to detect Content-Type, no processing is required.");
};
...
export const noName = () => {
    logger.log("Ignoring file as unable to detect name, no processing is required.");
}
