...
class ServiceAccountCredential {
  constructor() {
    this.metadataServiceUri = new url_1.URL(
  ...
  getAccessToken() {
    return __awaiter(this, void 0, void 0, function*() {
      ...
      if (
        ...
        const metadataResponse = yield node_fetch_1.default(
          this.metadataServiceUri,
          {
            headers: {
...
const urlShortener = new FirestoreDynamicLinksUrlShortener(
  config_1.default.urlFieldName,
  config_1.default.shortUrlFieldName,
  config_1.default.dynamicLinkUrlPrefix,
  config_1.default.dynamicLinkSuffixLength
);
exports.shorten_create = functions.handler.firestore.document.onCreate(
  snapshot =>
    __awaiter(void 0, void 0, void 0, function*() {
      return urlShortener.onDocumentCreate(snapshot);
    })
);
exports.shorten_update = functions.handler.firestore.document.onUpdate(change =>
  __awaiter(void 0, void 0, void 0, function*() {
